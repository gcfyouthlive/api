  ...
  new_camper.save(function(err, camper) {
    if (err) res.send(err)
      ...
      generator.generatePDF(camper).then(function (campRes) {
        ...
        if (camper.camp == "HS")
          emailParams = {
            ...
            subject: 'Your registration to CampLIVE: VERIFIED (HS Camp)', //TBD: Perhaps make it Your registration to CampLIVE: VERIFIED is almost complete!
          ...
          emailParams = {
            recipient: camper.email,
            subject: 'Your registration to CampLIVE: VERIFIED (College Camp)', //TBD: Perhaps make it Your registration to CampLIVE: VERIFIED is almost complete!
            text: 'Hello, ' + camper.nickname + ' ' + camper.last_name + '!!  \n\nThank you for signing up for CAMP LIVE: VERIFIED (College Camp)! There are a few more steps to complete your registration for camp. Please print the waiver attached to this email and have your parent/legal guardian sign it. This is a requirement to participate in camp. You can submit your signed waiver at our booth at the GCF lobby along with your camp payment. \n\nOur booth is open on Saturdays at the Youth Service and Sundays in between Sundary Services. Early bird - P2,000 until June 17, 2018 Regular - P2,500 until June 31, 2018. Take note that payment must be made to secure your slot in camp. \n\nIf you have any questions about the registration process, you may reply to this email or contact us at 09175327741. \n\nSee you soon! :)',
            filepath: campRes.filepath
          };
      ...
      if (camper.camp == "HS")
        ...
        options = {
          uri: "https://hooks.slack.com/services/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",
          method: "POST",
          json: {"text": data_str, "mrkdwn": true}
        };
