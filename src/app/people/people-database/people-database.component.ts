...
export class PeopleDatabaseComponent implements OnInit {
  ...
  databases = [
    ...
    {id: 4, name:'All College - Signups', query:"?camp=College"},
    {id: 5, name:'College Camp - Paid', query:"?camp=College&paid=true"},
    {id: 6, name:'College Camp - Unpaid', query:"?camp=College&paid=false"}
  ];
  activeDatabase = 0;
